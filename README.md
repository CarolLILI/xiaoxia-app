...
| 服务 | Token 消耗 | 费用 |
|------|-----------|------|
| **Kimi AI** | ~ 3,500,000 tokens | ¥ 117.74 元 |
| **Claude Code** | ~ 2,800,000 tokens | ¥ 85.50 元 |
| **合计** | ~ 6,300,000 tokens | **¥ 203.24 元** |
...
> 💰 **说明**: 实际费用根据 API 的计费标准和具体使用量计算。本项目使用了 Kimi AI 和 Claude Code 两种 AI 服务进行开发。
...
- [Kimi AI](https://kimi.moonshot.cn/) - AI 开发助手（主要开发助手）
- [Claude Code](https://claude.ai/code) - AI 编程助手（代码开发）
